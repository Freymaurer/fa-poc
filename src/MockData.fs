...
let MapFile =
    {
        Columns =
            [|
                MappingColumns.CreColumn
                MappingColumns.MapManColumn
                MappingColumns.CustomMapping
            |]
    }
...
let UserData =
    {
        Data = [|
            ...
            [| "Cre01.g014600"; "12.3"; "13.1"; "11.9"; "12.7" |]
            ...
            [| "Cre16.g663600"; "5.0";  "5.1";  "5.2";  "5.0"  |]
            [| "Cre17.g700900"; "3.3";  "3.2";  "3.4";  "3.5"  |]
            [| "Cre17.g709800"; "6.6";  "6.4";  "6.5";  "6.7"  |]
