...
type Components =
    ...
    static member UserDataTable(userData: string [] [], selectedColumn, setSelectedColumn) =
        Html.div [
                prop.className "overflow-auto max-h-[600px] max-w-[600px]"
                prop.children [
                Html.table [
    ...
    static member MapFileColNameDropdown(mapFile: MapFile, setSelected: string -> unit) =
        ...
        Html.div [
            ...
            prop.children [
                Html.div [
                    ...
                    prop.tabIndex 0
                    prop.role "button"
                    prop.text "Select data id type"
                ]
                Html.ul [
                    prop.tabIndex 0
                    prop.className "dropdown-content menu p-2 shadow bg-base-300 rounded-box w-52"
                    prop.children [
    ...
    static member SelectIdColFromUserData() =
        ...
        Html.div [
            ...
            prop.children [
                Html.div [
                    prop.className "prose w-full"
                    prop.text "Select ID column from your data!"
                ]
                ...
                | userData ->
                    Html.div [
                        prop.className "flex lg:flex-row flex-col-reverse gap-4"
                        prop.children [
                            ...
                            Html.div [
                                ...
                                prop.children [
                                    Components.MapFileColNameDropdown(mapFile, fun name -> console.log name)
                                ]
                            ]
                        ]
                    ]
